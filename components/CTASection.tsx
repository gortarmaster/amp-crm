  ...
  return (
    <section className="relative flex min-h-[70vh] flex-col items-center justify-center px-6 py-24 text-center snap-start">
      ...
      <div className="relative z-10 flex flex-col items-center gap-8">
        <div>
          <h2 className="text-display-2 text-ink-primary">
            Want to take a peek<br />at what I&apos;m building?
          </h2>
        </div>

        <button
          onClick={handleSignIn}
          className="inline-flex items-center gap-3 rounded-token-md border border-line bg-bg-card px-8 py-4 text-body font-medium text-ink-primary transition-colors hover:border-gold/20 hover:bg-bg-hover"
        >
